        ...
        <button
          ...
          className={`${size} transition-all duration-150 ${
            star <= (hoverRating || rating) 
              ? 'text-yellow-400' 
              : 'text-gray-300'
          } ${interactive ? 'hover:text-yellow-400 cursor-pointer hover:scale-110' : 'cursor-default'}`}
    ...
    return (
      <div className="flex flex-col justify-center items-center min-h-screen bg-gray-50">
        <div className="text-center p-8 bg-white rounded-2xl shadow-lg max-w-md">
          ...
          <p className="text-gray-600 mb-4">{message || "Unable to load the ad details"}</p>
          <button 
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div className="text-gray-600">
                  <span className="text-2xl font-bold text-gray-800">{ad.averageRating?.toFixed(1) || '0.0'}</span>
                  <span className="ml-2">({ad.ratings?.length || 0} reviews)</span>
                </div>
              </div>

              {user && (
                <div className="border-t pt-6">
                  <p className="text-lg font-medium text-gray-800 mb-3">Rate this ad:</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between items-center mt-3">
                        ...
                        >
                          {isSubmittingComment && <FaSpinner className="animate-spin" />}
              ...
              {ad.comments?.length > 0 ? (
                <div className="space-y-6">
                  {ad.comments.map((comment) => (
                    <div key={comment._id || `${comment.userId}-${comment.createdAt}`} 
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800">{ad.user?.FullName || 'Anonymous'}</h4>
                  <p className="text-gray-600 text-sm">Member since {new Date(ad.createdAt).getFullYear()}</p>
                </div>
              </div>
            ...
            {/* Ad Stats */}
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Ad Statistics</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{ad.comments?.length || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Rating</span>
                  <div className="flex items-center">
                    <StarRating rating={ad.averageRating || 0} interactive={false} size="text-sm" />
                    <span className="ml-2 font-medium">({ad.ratings?.length || 0})</span>
                  </div>
                </div>
              </div>
            </div>
